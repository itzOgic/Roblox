...
local WeightBox = sec:Textbox("Weight Target", false, function(t) WeightVal = t end)
local SparklingToggle = sec:Toggle("Require Sparkling", false, "SparklingToggle", function(t) end)
local ShinyToggle = sec:Toggle("Require Shiny", false, "ShinyToggle", function(t) end)
